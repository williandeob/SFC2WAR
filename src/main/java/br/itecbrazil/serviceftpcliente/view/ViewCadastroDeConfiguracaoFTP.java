 ...
 ControllerCadastroConfiguracaoFTP controllerCadastroConfiguracaoFTP;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCadastroDeConfiguracaoFTP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ViewCadastroDeConfiguracaoFTP dialog = new ViewCadastroDeConfiguracaoFTP(new javax.swing.JFrame(), true);
